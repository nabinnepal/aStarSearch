...
namespace AStarSearchImplementation
{
    ...
    public class ButtonsPanel : Panel
    {
        ...
        private readonly Label lblNodesExplored; 

        public ButtonsPanel()
        {
            MouseClick += ButtonsPanel_MouseClick;
            lblNodesExplored = new Label();

            lblNodesExplored.Location = new Point(240, 20);
            lblNodesExplored.ForeColor = Color.White;
            lblNodesExplored.BackColor = Color.Black;
            Controls.Add(lblNodesExplored);
        ...
        public string NodesExplored
        {
            get{ return lblNodesExplored.Text;}
            set{ lblNodesExplored.Text = value;}
        }
